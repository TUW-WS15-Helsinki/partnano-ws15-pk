...
public class Aufgabe3 {
    ...
    // count variable for counting the number of recursion calls
    static int count = 0;

    public static void main(String[] args) {
        System.out.println("\nAnzahl der Rekursionsaufrufe: " + rec(3, 'A', 'B', 'C', 1));
    }

    private static int rec(int i, char a, char b, char c, int l) {

        // count +1 and printing of level info
        count++;
        System.out.println("Aufrufebene " + l + ": i = " + i + ", a = " + a + ", b = " + b + ", c = " + c);

        // code from the lecture
        // always move plates from leftes to rightest tower, move the towers
        if (i > 0) {
            rec(i -1, a, c, b, l +1);
